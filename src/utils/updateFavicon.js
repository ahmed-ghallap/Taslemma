export default function updateFavicon() {
  ...
  const primaryColor =
    styles.getPropertyValue("--color-primary-300").trim() || "#ddd";
  const secondaryColor =
    styles.getPropertyValue("--color-secondary-700").trim() || "#000";
  const primaryColorDark =
    styles.getPropertyValue("--color-primary-400").trim() || "#ddd";
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40">
  ...
  <g transform="translate(20 20) scale(1.5) translate(-12 -12)">
    ...
    <path fill="${secondaryColor}" opacity="0.4"
